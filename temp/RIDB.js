...
const params = `&activity=${activities}&latitude=47.1595847&longitude=-122.4984306&radius=200&query=Creek&limit=1`;

// facility specifics
// facilities/:id/facilityaddresses - for street addresses
// facilities/:id/media - for pictures
// 201792,232023,232033,203833,234086
// const url = 'https://ridb.recreation.gov/api/v1/facilities/234086/facilityaddresses?'
// const url = 'https://ridb.recreation.gov/api/v1/facilities/232023/media?'
// const params = '';

axios.get(url + apiKey + params)
  .then((results) => {
    console.log(results.data.RECDATA[0])
